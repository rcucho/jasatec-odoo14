...
class FormulariosColumnaConectada(models.Model):
    ...
    #move_interno2 = fields.Many2many('stock.move', relation='project_task_herramientas_rel', column1='name', column2='picking_id', string='Transferencia Interna de Materiales2')
